...
OUT_NB = "lidar_histogram_sim_v42.ipynb"
...
def to_markdown_disabled(cell, reason, ver="v42"):
...
# 追加 v42 新模块
out_cells.append(md_cell("v42_new_header", NEW_HEADER_MD))
out_cells.append(code_cell("v42_module_19_energy", MODULE_19))
out_cells.append(code_cell("v42_module_20_snr", MODULE_20))
