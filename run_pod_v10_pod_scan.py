# -*- coding: utf-8 -*-
"""PoD_esti v10 —— 多进程 PoD 临界点扫描（ProcessPool，吃满 CPU）。

用法：
    python build_pod_core_v10.py
    python run_pod_v10_noise_scan.py --workers 20   # 须先有噪声缓存
    python run_pod_v10_pod_scan.py --workers 20
"""
...
def main():
    ...
    if not core._noise_cache_complete(core.NOISE_RES):
        ...
        print("  python run_pod_v10_noise_scan.py --workers 20")
        return 2
    if not core.THRESH:
    ...
    print(f"PoD 扫描：待跑 {len(pending)} / {n_total} 档；"
