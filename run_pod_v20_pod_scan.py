# -*- coding: utf-8 -*-
"""PoD_esti v20 —— 多进程 PoD 临界点扫描（统一 bg 网格）。

用法：
    python build_pod_core_v20.py
    python run_pod_v20_noise_scan.py --workers 20   # 须先有噪声缓存
    python run_pod_v20_pod_scan.py --workers 20
"""
...
def main():
    ...
    if not core._noise_cache_complete(core.NOISE_RES):
        ...
        print("  python run_pod_v20_noise_scan.py --workers 20")
        return 2
    if not core.THRESH:
