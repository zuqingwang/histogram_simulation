# -*- coding: utf-8 -*-
"""
build_crosstalk_v10.py —— 生成 crosstalk_sim_v10.ipynb
========================================================
长焦模组 A 组（16 激光器）编码串扰/鬼影仿真（理想 δ 回波模型）。

与历史版本 v01~v03 的区别（本版重写核心逻辑）：
...
CELL_HEADER = r'''# 串扰仿真 v10 —— 长焦 A 组 16 激光器编码鬼影检测（理想 δ 回波）
...
cells = [
    md_cell("v10_header", CELL_HEADER),
    code_cell("v10_imports", CELL_IMPORTS),
    code_cell("v10_excel", CELL_EXCEL),
    code_cell("v10_encoding", CELL_ENCODING),
    code_cell("v10_timing_plot", CELL_TIMING_PLOT),
    code_cell("v10_detect", CELL_DETECT),
    code_cell("v10_verify", CELL_VERIFY),
    code_cell("v10_echo_map", CELL_ECHO_MAP),
    code_cell("v10_cumulative", CELL_CUMULATIVE),
    code_cell("v10_summary", CELL_SUMMARY),
]
